...
int main() {
  ...
  // initialize the reference velocity, this value will change with the planning
  double ref_vel = 0.0;

  //get a vehicle object, with the initial configuration.
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          //this will help to get a smooth transition from the previous
          // path to the actual path
          ...
          if(prev_size < 2){
              ...
              //use the previous path's end point as initial reference
              //set the reference state as previous path end point
		  ...
		  //This vectors will contain the actual (x,y) points we will use for the planner 
          vector<double> next_x_vals;
          vector<double> next_y_vals;

          //start with points of the previous path
          ...
          for(int i = 0; i < 50-previous_path_x.size(); i++){
            ...
            //rotate back to normal after the earlier rotation
